...
const Blogs = () => {
    ...
    const getData = async () => {
        try {
            ...
            const data = await ApiServices.getBlogs(params);
...

        {
            ...
            cell: ({ row }) => (
                ...
                <Box variant="contained" color="primary" sx={{ cursor: 'pointer', display: 'flex', gap: 2 }} >
                    ...
                    <IconButton onClick={() => { navigate(`/update-blog/${row?.original?._id}`) }}>
    ...
    const HandleDelete = async () => {
        ...
        try {
            ...
            const promise = ApiServices.DeleteBlog(obj);
        ...
        <div>
            ...
            <Paper sx={{ width: "100%", overflow: "hidden", boxShadow: 'none' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <PrimaryButton onClick={() => navigate('/create-blog')} title={"Create"} />
                </Box>
