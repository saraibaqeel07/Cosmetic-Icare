...
const Doctors = () => {
    ...
    const getData = async () => {
        try {
            ...
            const data = await ApiServices.getDoctors(params);
...

        {
            ...
            cell: ({ row }) => (
                <Box variant="contained" color="primary" sx={{ cursor: 'pointer', display: 'flex' }} >
                    ...
                    <Chip sx={{ backgroundColor: '#5f64fd', color: 'white', width: '100%' }} label={row?.original?.specialty} />
                </Box>
            ),
        },
      
        {
            ...
            cell: ({ row }) => (
                ...
                <Box variant="contained" color="primary" sx={{ cursor: 'pointer', display: 'flex', gap: 2 }} >
                    ...
                    <IconButton onClick={() => navigate("/update-doctor", { state: row?.original })}>
    ...
    const HandleDelete = async () => {
        ...
        try {
            ...
            const promise = ApiServices.DeleteDoctor(obj);
        ...
        <div>
            ...
            <Paper sx={{ width: "100%", overflow: "hidden", boxShadow: 'none' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <PrimaryButton onClick={() => navigate('/create-doctor')} title={"Create"} />
                </Box>
