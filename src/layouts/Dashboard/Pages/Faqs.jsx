...
const Faqs = () => {
    ...
    const getData = async () => {
        try {
            ...
            const data = await ApiServices.getFaqs(params);


            setData(data?.data?.faqs)
    ...
    const HandleDelete = async () => {
        ...
        try {
            ...
            const promise = ApiServices.DeleteFaq(obj);
        ...
        <div>
            ...
            <Paper sx={{ width: "100%", overflow: "hidden", boxShadow: 'none' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <PrimaryButton onClick={() => navigate('/create-faq')} title={"Create"} />
                </Box>
