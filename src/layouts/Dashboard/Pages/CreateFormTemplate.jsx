...
const CreateFormTemplate = () => {
    ...
    const CreateFormTemplate = async (fromData) => {
        setLoader(true);
        ...
        try {
            let obj = {
                ...
                allergies_section: getValues('allergic'),
                questionnaire: fromData?.records,
            };
            
            console.log(obj);

            const promise = ApiServices.CreateFormTemplate(obj);
    ...
    return (
        <div>
            ...
            <Paper sx={{ width: "100%", overflow: "hidden", boxShadow: 'none', backgroundColor: '#ffff', borderRadius: '12px' }}>
                ...
                <Box component={'form'} p={3} sx={{ borderRadius: '12px' }} onSubmit={handleSubmit(CreateFormTemplate)} >
