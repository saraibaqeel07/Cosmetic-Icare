                            ...
                            <Grid item lg={3} md={4} sm={6} xs={6} mt={2}>
                                ...
                                <FormControl component="fieldset">
                                    ...
                                    <RadioGroup row value={patientType} onChange={handleChange}>
                                        <FormControlLabel disabled={true} value="existing" control={<Radio />} label="Existing" />
                                        <FormControlLabel disabled={true} value="new" control={<Radio />} label="New" />
                                    </RadioGroup>
                                </FormControl>
                            </Grid>
                            <Grid item lg={3} md={4} sm={6} xs={6} mt={2}>
...
export default CompletedFormDetail
