...
const CreateAfterDocument = () => {
    ...
    const CreateAfterDocument = async () => {
        setLoader(true);
        try {
            let obj = {
            ...
            const promise = ApiServices.CreateAfterDocument(obj);
    ...
    return (
        <div>
            ...
            <Paper sx={{ width: "100%", overflow: "hidden", boxShadow: 'none', backgroundColor: '#eff6ff', borderRadius: '12px' }}>
                ...
                <Box component={'form'} p={3} sx={{ borderRadius: '12px' }} onSubmit={handleSubmit(CreateAfterDocument)} >
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', width: '100%', mt: 2 }}>
                        <PrimaryButton loader={loader} disabled={imageLoader || loader} type={'submit'} title={"Create"} />
                    </Box>
                </Box>
            </Paper>
        </div>
...
export default CreateAfterDocument
